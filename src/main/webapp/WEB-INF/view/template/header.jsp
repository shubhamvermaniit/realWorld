              ...
              <input type="hidden" name="${_csrf.parameterName }" value="${_csrf.token }" />
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                  ...
                  <li><a href="home">Home</a></li>
                    ...
                    <li><a href="Brand">Category</a></li>
                  <li class="dropdown">
        <a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true">
        PRODUCTS
        <span class="caret"></span></a>
        <ul class="dropdown-menu">
         <li><a href="${pageContext.request.contextPath}/user/i-phone">I-phone</a></li>
          <li><a href="${pageContext.request.contextPath}/user/samsung">Samsung</a></li>
          <li><a href="${pageContext.request.contextPath}/user/htc">HTC-World</a></li> 
          <li><a href="${pageContext.request.contextPath}/user/intex">Intex</a></li> 
